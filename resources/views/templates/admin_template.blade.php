        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link"href="{{ route('enseignant.index') }}">Gestion Enseignant</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Gestion Etudiant</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Gestion Cours</a>
              </li>
            </ul>
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link"  href="{{ route('admin_profil') }}">Mon Profil</a>
                </li>
                <li class="nav-item">
                <a class="nav-link btn btn-sm btn-outline-warning" data-bs-toggle="modal" data-bs-target="#disconnect"  href="{{ route('admin_profil') }}">Se déconnecter</a>
